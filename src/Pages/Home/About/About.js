        ...
        <div className="hero my-5">
            <div className="hero-content flex-col lg:flex-row">
                <div className='w-1/2 relative'>
                    ...
                    <img src={parts} alt="parts" className="rounded-lg shadow-2xl absolute w-3/5 right-5 top-1/2 border-8" />
                </div>
                <div className='w-1/2'>
                    <p className='text-2xl text-red-600 font-bold '>About Us</p>
                    <h1 className="text-5xl font-bold my-5">We are qualified <br /> & of experience <br />
                        in this field</h1>
